...
router.get('/mechanics/history', authMiddleware, adminOnly, adminController.getMechanicHistory);
...
router.get('/garages/history', authMiddleware, adminOnly, adminController.getGarageHistory);
